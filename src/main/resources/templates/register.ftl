...
<body style="background:url(/image/login_bg.jpg) no-repeat;">
    ...
    <div class="container wrap1" style="height:450px;">
            <div class="col-sm-8 col-md-5 center-auto pd-sm-50 pd-xs-20 main_content">
                <h2 class="mg-b20 text-center">注 册</h2>
                <p id="info" style='color: red;font-size: 15px;display: none;text-align: center;'>用户名已存在</p>
                <form id="form">
                    ...
                    <input id="login_btn" class="login_btn" value="注 册" style="text-align: center"/>
               </form>
        </div>
    </div>
